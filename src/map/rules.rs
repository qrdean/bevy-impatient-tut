...
pub fn build_props_layer(
    ...
    terrain_model_builder.create_model(
        ...
        vec![
            ...
            SpawnableAsset::new("small_tree_top").with_grid_offset(GridDelta::new(0, 1, 0)).with_tile_type(TileType::Tree),
        ],
    );
    ...
    terrain_model_builder
        .create_model(
            ...
            vec![
                ...
                SpawnableAsset::new("big_tree_1_tl").with_grid_offset(GridDelta::new(0, 1, 0)).with_tile_type(TileType::Tree),
            ],
        )
        .with_weight(PROPS_WEIGHT);
    ...
    terrain_model_builder
        .create_model(
            ...
            vec![
                ...
                SpawnableAsset::new("big_tree_1_tr").with_grid_offset(GridDelta::new(0, 1, 0)).with_tile_type(TileType::Tree),
            ],
        )
        .with_weight(PROPS_WEIGHT);
    ...
    terrain_model_builder
        .create_model(
            ...
            vec![
                ...
                SpawnableAsset::new("big_tree_2_tl").with_grid_offset(GridDelta::new(0, 1, 0)).with_tile_type(TileType::Tree),
            ],
        )
        .with_weight(PROPS_WEIGHT);
    ...
    terrain_model_builder
        .create_model(
            ...
            vec![
                ...
                SpawnableAsset::new("big_tree_2_tr").with_grid_offset(GridDelta::new(0, 1, 0)).with_tile_type(TileType::Tree),
            ],
        )
        .with_weight(PROPS_WEIGHT);
    ...
    // Plants
    terrain_model_builder.create_model(plant_prop.clone(), vec![SpawnableAsset::new("plant_1").with_tile_type(TileType::Rock)]);
    terrain_model_builder.create_model(plant_prop.clone(), vec![SpawnableAsset::new("plant_2").with_tile_type(TileType::Rock)]);
    terrain_model_builder.create_model(plant_prop.clone(), vec![SpawnableAsset::new("plant_3").with_tile_type(TileType::Rock)]);
    terrain_model_builder.create_model(plant_prop.clone(), vec![SpawnableAsset::new("plant_4").with_tile_type(TileType::Rock)]);
